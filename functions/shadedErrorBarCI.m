function varargout=shadedErrorBarCI(x,y,errBar,varargin)
...
% % Modified by Jesus  Now they are absolute values, to fit CI instead 
%          of error bars respect to the mean. (lines 160-161)
%          ** alternatively ** errBar can be a cellArray of two function 
%          handles. The first defines statistic the line should be and 
%          the second defines the error bar.
%
